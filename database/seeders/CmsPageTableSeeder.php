...
class CmsPageTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $cmsPagesRecords = [
            ...
            ['id'=>2,'title'=>'Terms & Conditions','description'=>'Content is coming soon','url'=>'terms-condition','meta_title'=>'Terms & Conditions','meta_description'=>'Terms & Conditions Content','meta_keywords'=>'terms, terms condition','status'=>1],
