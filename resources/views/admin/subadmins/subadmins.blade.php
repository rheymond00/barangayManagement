                    ...
                    @foreach($subadmins as $subadmin)
                      <tr>
                        ...
                        <td>
                          ...
                          &nbsp;&nbsp;
                          <a style='color:#3f6ed3' class="confirmDelete" name="Subadmin" title="Delete Subadmin" <?php /*href="javascript:void(0)" record="subadmin" recordid="{{$subadmin->id}}"*/?> href="{{ url('admin/delete-subadmin/'.$subadmin->id)}}"><i class="fas fa-trash"></i></a>
                          &nbsp;&nbsp;
